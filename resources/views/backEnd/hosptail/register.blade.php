...
<section class="signup-step-container col-md-6 container bg-registr">
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                <form enctype="multipart/form-data" action = "{{route('hosptail_post_Register')}}" method="POST" role="form" action="index.html" class="login-box">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Hosptail Name</label>
                                <input class="form-control @error('hosptailName') is-invalid @enderror" type="text" name="hosptailName" placeholder="">
                                @error('hosptailName')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('Primary_Speciality') is-invalid @enderror" type="text" name="Primary_Speciality" placeholder="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('Primary_Speciality') is-invalid @enderror" type="text" placeholder="" name="Medical_License_Number">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Hosptail License</label>
                                <input class="form-control @error('Hosptail_License') is-invalid @enderror" type="file" placeholder="" name="Hosptail_License">
                                @error('Hosptail_License')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
