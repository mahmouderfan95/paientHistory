                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="Hospital Name">
                            </div>
                        </div>
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h3 font-weight-bold">Primary Speciality</label>
                                <input class="form-control" type="text" name="name" placeholder="Primary Speciality">
                            </div>
                        </div>
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h3 font-weight-bold">Medical License Namber</label>
                                <input class="form-control" type="text" placeholder="Medical License Namber" name="name">
                            </div>
                        </div>
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h3 font-weight-bold">Hospital License</label>
                                <input class="form-control" type="text" placeholder="Hospital License" name="birthday">
                            </div>
                        </div>
