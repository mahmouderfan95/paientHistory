...
<section class="signup-step-container col-md-6 container bg-registr">
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                <form enctype="multipart/form-data" action = "{{route('labs_post_Register')}}" method="POST" role="form" action="index.html" class="login-box">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('labsName') is-invalid @enderror" type="text" name="labsName" placeholder="">
                                @error('labsName')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>labs License</label>
                                <input class="form-control @error('labs_License') is-invalid @enderror" type="file" placeholder="" name="labs_License">
                                @error('labs_License')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
