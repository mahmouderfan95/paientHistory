              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body ml-2 d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">{{$labs->firstName}}</span>
                  </div>
                </div>
              </a>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-8 col-md-10">
            <h1 class="display-2 text-white">Hello {{$labs->firstName}}</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 order-xl-2">
          <div class="card card-profile">
            ...
            <div class="card-body pt-0">
              ...
              <h5 class="h3 font-weight-700 mb-5 text-center mt-3">{{$labs->firstName}}</h5>
              <div class="">
                <h5 class="h4 mt-3"><i class="fas fa-male mr-4"></i>{{$labs->gender}}</h5>
                <h5 class="h4  mt-3"><i class="fa fa-calendar-check mr-3" aria-hidden="true"></i> {{$labs->BirthDate}}</h5>
                <div class="h4  mt-3"><i class="fas fa-location-arrow mr-3"></i> {{$labs->country}}</div>
                <div class="h4  mt-3"><i class="fas fa-mail-bulk mr-3"></i> {{$labs->email}}</div>
                <div class="h4 mt-3 mb-5"><i class="fa fa-phone mr-3" aria-hidden="true"></i> {{$labs->phoneNumber}}
                </div>
              </div>
            </div>
          </div>
